...
public class SphericalCamera : MonoBehaviour
{
    ...
    private void HandleInput()
    {
        ...
        distance = Mathf.Clamp(distance, 2.0f, 100.0f);                         //거리제한
    }
    ...
    private void UpdateCameraPosition()
    {
        ...
        float z = distance * Mathf.Sin(verticalAngleRadians) * Mathf.Cos(horizontalAngleRadians);
        float y = distance * Mathf.Sin(verticalAngleRadians);
